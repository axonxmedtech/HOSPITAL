                ...
                <div className="overflow-x-auto">
                    <table className="min-w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {loading ? (
                                <tr><td colSpan="6" className="px-6 py-10 text-center text-gray-400 font-medium">Loading invoices...</td></tr>
                            ) : invoices.length === 0 ? (
                                        ...
                                        <td className="px-6 py-4 text-center">
                                            {inv.postingStatus === 'DRAFT' ? (
                                                <button 
                                                    ...
                                                    className="px-3 py-1 bg-gray-900 text-white text-[10px] font-bold rounded-md hover:bg-gray-800 transition-colors"
                                                >
                                                    Post & Inward
                                                </button>
                                            ) : (
