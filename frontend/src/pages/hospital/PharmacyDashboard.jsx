        ...
        if (pendingPrescriptions.length === 0) {
            return (
                <div className="text-center py-10 bg-white rounded-lg shadow-sm">
                    <p className="text-gray-500 text-lg">No pending prescriptions to dispense.</p>
                </div>
            );
        }
    ...
    const InventoryTab = () => {
        ...
        const columns = [
            ...
            columnHelper.display({
                ...
                header: 'Actions',
                cell: info => (
                    <button className="text-blue-600 hover:text-blue-900" onClick={() => toastError("Edit Stock Coming Soon")}>
                        Edit
                    </button>
                ),
            }),
                ...
                <main className="flex-1 overflow-x-hidden overflow-y-auto bg-neutral-50 p-6">
                    <div className="space-y-6">
                        <PageHeader
                            ...
                            actions={
                                <button className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700" onClick={loadData}>
                                    Refresh Data
                                </button>
                            }
                        />
                                ...
                                <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                                    ...
                                    <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                                                ...
                                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                                    ...
                                                    <div className="mt-4 space-y-3">
                                                        ...
                                                        <div className="bg-blue-50 p-3 rounded border border-blue-100">
                                                            <p className="text-sm text-blue-600 font-medium">Prescribed Item</p>
                                                        ...
                                                        <div className="grid grid-cols-2 gap-4">
                                                            ...
                                                            <div className={`border p-2 rounded ${dispenseModal.stockAvailable < 1 ? 'bg-red-50 border-red-200' : 'bg-green-50 border-green-200'}`}>
                                                                <span className="block text-xs text-gray-500">Available Stock</span>
                                                                <span className={`text-xl font-bold ${dispenseModal.stockAvailable < 1 ? 'text-red-700' : 'text-green-700'}`}>
                                                        ...
                                                        {dispenseModal.stockAvailable < 1 && (
                                                            <div className="text-red-600 text-sm font-medium bg-red-50 p-2 rounded">
                                                                ⚠️ Insufficient Stock. Cannot dispense.
                                                            </div>
                                                        )}
                                                    </div>
                                                </div>
                                        ...
                                        <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                            ...
                                            ${dispenseModal.stockAvailable < 1 ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'}`}
                                            >
                                                Confirm Dispense
                                            </button>
                                            <button
