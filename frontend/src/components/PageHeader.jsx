        ...
        <div className={`flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6 ${className}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                ...
                {onAdd && (
                    <button
                        onClick={onAdd}
                        className="bg-primary-600 hover:bg-primary-700 text-white px-5 py-2.5 rounded-xl font-semibold shadow-soft hover:shadow-soft-lg transform hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
                    >
