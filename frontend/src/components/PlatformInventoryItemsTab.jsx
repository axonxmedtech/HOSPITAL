...
export default function PlatformInventoryItemsTab({ hospitalType = null }) {
    ...
    const handleDelete = async (item) => {
        if (!window.confirm(`Are you sure you want to delete ${item.name}? This will prevent new hospital service mappings, but won't delete existing records.`)) {
            return;
        }
    ...
    const handleImportCsv = async (e) => {
        ...
        try {
            ...
            toastError(extractError(err, 'Failed to import CSV file. Make sure file formatting is correct.'));
        } finally {
            ...
            <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
                {loading && items.length === 0 ? (
                    ...
                    <div className="p-12 text-center text-gray-400">
                        ...
                        <p className="text-sm text-gray-400 mt-1">Try refining your search or add a new master item.</p>
                    </div>
                ) : (
                        ...
                        <table className="min-w-full text-sm text-left">
                            <thead className="bg-gray-50 border-b border-gray-200">
                                <tr>
                                    ...
                                    <th className="px-6 py-3.5 text-xs font-semibold text-gray-500 uppercase tracking-wider">Item Name</th>
                ...
                {totalPages > 1 && (
                    <div className="bg-gray-50 px-6 py-4 border-t border-gray-200 flex items-center justify-between">
                        <div className="text-sm text-gray-500">
                            ...
                            <span className="font-semibold">{totalElements}</span> master items
                        </div>
