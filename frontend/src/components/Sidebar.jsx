...
const menuIcons = {
    ...
    'Wards & Beds': (
        <svg className="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7h18v10H3V7zm2 2v6h14V9H5zM7 11h2v2H7v-2z" />
        </svg>
    ),
    'Medicine Master': (
        <svg className="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    // Hospital Admin grouped-sidebar section headers
    'Patient Management': (
        <svg className="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
        </svg>
    ...
    'Rooms': (
        <svg className="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 4a3 3 0 00-3 3v12a1 1 0 001 1h12a1 1 0 001-1V7a3 3 0 00-3-3H8z" />
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 12h.01" />
        </svg>
    ),
    'Staff': (
        <svg className="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const Sidebar = ({ title, tabs, activeTab, onTabChange, onToggleGroup, footerTitle, footerData, variant = 'plain', isCollapsed = false, showOnMobile = false }) => {
                ...
                {tabs.map((tab) => {
                    ...
                    return (
                        <div key={tab.id} className="space-y-1">
                            <button
                                onClick={() => (hasSubItems && onToggleGroup) ? onToggleGroup(tab.id) : onTabChange(tab.id)}
