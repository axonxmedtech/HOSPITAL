...
const vitalsService = {
    ...
    toggle: async (vitalKey, enabled) => (await apiClient.put(`/hospital/vitals/${vitalKey}`, { enabled })).data,
    addCustom: async (name, unit) => (await apiClient.post('/hospital/vitals/custom', { name, unit })).data,
    deleteCustom: async (publicId) => (await apiClient.delete(`/hospital/vitals/custom/${publicId}`)).data,
};
